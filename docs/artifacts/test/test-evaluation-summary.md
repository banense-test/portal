...
| Is the regression path in place? | The pipeline that will carry it builds and tests on `main` (run `36049582928`). No suite exists yet |
| Are there defects to report? | No — the tracker holds no issues |
