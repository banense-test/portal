...
| R004 — the stand-in environment is not ready | Every use case depends on the two CON-028 seams | Avoided: the stand-in environment is the first construction item of iteration 1 |
