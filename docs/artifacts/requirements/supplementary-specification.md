...
| INT-001 | CON-002, CON-003, CON-025 | Derives | Design Model |
| INT-002 | CON-004, CON-005, CON-016 | Derives | Design Model |
| INT-003 | AC-006, CON-022 | Derives | Design Model |
| INT-004 | FR-003 | Derives | Design Model |
| INT-005 | CON-026 | Derives | Software Architecture Document |
